...
export const BookingService = {
  createBooking: async (userId: string, scheduleId: string): Promise<TBooking> => {
  ...
  getMyBookings: async (userId: string): Promise<TBooking[]> => {
  ...
  cancelBooking: async (userId: string, bookingId: string) => {
